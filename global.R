...
areaChoices <- list(
  "Local enterprise partnership" = list(
    "Black Country" = "Black Country LEP",
    ...
    "Coventry and Warwickshire" = "Coventry and Warwickshire LEP",
    "Cumbria" = "Cumbria LEP",
    "Derby, Derbyshire, Nottingham and Nottinghamshire" = "Derby, Derbyshire, Nottingham and Nottinghamshire LEP",
    "Dorset" = "Dorset LEP",
    "Enterprise M3" = "Enterprise M3 LEP",
    "Gloucestershire" = "Gloucestershire LEP",
    "Greater Birmingham and Solihull" = "Greater Birmingham and Solihull LEP",
    "Greater Cambridge and Greater Peterborough" = "Greater Cambridge and Greater Peterborough LEP",
    ...
    "Oxfordshire" = "Oxfordshire LEP",
    "Sheffield City Region" = "Sheffield City Region LEP",
    "Solent" = "Solent LEP",
  ...
  "Local skills partnership area" = list(
    ...
    "Gloucestershire" = "Gloucestershire LSIP",
    ...
    "Norfolk and Suffolk" = "Norfolk and Suffolk LSIP",
  ...
  "Local authority" = list(
    ...
    "Barrow-in-Furness" = "Barrow-in-Furness LADU",
    ...
    "South Lakeland" = "South Lakeland LADU",
