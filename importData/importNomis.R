...
source("~/RProjects/lsip_dashboard/R/importEmp.R", echo=TRUE)

### 2 Employment by occupation ----
source("~/RProjects/lsip_dashboard/R/importEmpOcc.R", echo=TRUE)

### 3 Employment by industry------------
source("~/RProjects/lsip_dashboard/R/importEmpIndustry.R", echo=TRUE)

### 4 UK Business Count----
source("~/RProjects/lsip_dashboard/R/importEnterprises.R", echo=TRUE)

### 5 Skill by age gender ------------
source("~/RProjects/lsip_dashboard/R/importQualification.R", echo=TRUE)
